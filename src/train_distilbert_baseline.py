# ============================================================
# Phase 2 – Step 3.3.4
# DistilBERT Fine-Tuning with Research-Grade Checkpointing
# ============================================================
...
LR = 2e-5
SAVE_EVERY_STEPS = 5000        # storage-aware checkpointing

TRAIN_PATH = r"D:\research_sprint\data\processed\train.csv"
VAL_PATH   = r"D:\research_sprint\data\processed\validation.csv"

CHECKPOINT_DIR = "models/distilbert_baseline_checkpoints"
FINAL_MODEL_DIR = "models/distilbert_baseline_final"
...
def save_checkpoint(state, epoch, batch_idx, global_step, val_loss=None):
    ...
    filename = f"distilbert_{tag}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pt"
...
def main(resume_checkpoint=None):
    ...
    print(f"\n✅ Final DistilBERT baseline saved to: {FINAL_MODEL_DIR}")
    print("\nTraining complete.")
...
if __name__ == "__main__":
    ...
    resume_ckpt = None
    # resume_ckpt = "models/distilbert_baseline_checkpoints/your_checkpoint_here.pt"

    main(resume_checkpoint=resume_ckpt)
